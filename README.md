...
**Vet Clinic** is a data structure that stores information about animals, animals' owners, clinic employees and visits.
...
```sh
  cd my-folder
  git clone https://github.com/amexabee/vet_clinic.git
```
